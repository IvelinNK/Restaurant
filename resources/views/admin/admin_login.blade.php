...
<head>
        <title>PartyBox</title><meta charset="UTF-8" />
        ...
        <form id="loginform" class="form-vertical" method="POST" action="{{ route('admin') }}">
            @csrf
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_ly"><i class="icon-lock"></i></span><input type="password" name="password" placeholder="Парола" />
                        </div>
                    </div>
                </div>
            ...
            <form id="recoverform" action="#" class="form-vertical">
                ...
                <div class="form-actions">
                    <span class="pull-left"><a href="#" class="flip-link btn btn-success" id="to-login">&laquo; Обратно за Вход</a></span>
                    <span class="pull-right"><a class="btn btn-info">Възстанови</a></span>
                </div>
            </form>
        </div>
